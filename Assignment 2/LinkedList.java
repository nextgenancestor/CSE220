...
public class LinkedList implements List {
  ...
  public int indexOf(Object e) {
    ...
    int index = 0;
    for(Node n = header; n != header; n = n.next){
  ...
  public boolean remove(Object e) {
    ...
    boolean toReturn = false;
    Node n = null;
    for(n = header.next; n != header; n = n.next){
      if(n.element.equals(e)){
        toReturn = true;
        break;
      }
  ...
  public void reverse() {
    ...
    for(int count = 0; count < size/2; count++){
      System.out.println("Supposedly exchanging " + forward.element + " with " + backward.element);
      Object temp = forward.element;
      forward.element = backward.element;
      backward.element = temp;
...
//        return false;
  ...
  public void printR(){
    ...
    System.out.println();
    Node q = header.next.next.next.next.next;
    System.out.print(q.element + " ");
    System.out.println(q.prev.element);
  }
